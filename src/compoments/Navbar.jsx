    ...
    <div>
      <div className='w-[100%] flex justify-between items-center font-semibold'>
        ...
        <div className='flex items-center gap-4'>
            <p className='bg-white text-black text-[15px] px-4 py-1 rounded-2xl hidden md:block cursor-pointer'>Khám phá Premium</p>
            <p className='bg-black py-2 px-3 rounded-2xl text-[15px] cursor-pointer'>Cài đặt ứng dụng</p>
